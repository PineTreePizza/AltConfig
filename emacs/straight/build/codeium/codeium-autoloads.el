;;; codeium-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:


;;;### (autoloads nil "codeium" "codeium.el" (0 0 0 0))
;;; Generated autoloads from codeium.el

(defvar cl-struct-codeium-state-tags)

(cl-defsubst codeium-state-p (cl-x) (declare (side-effect-free error-free)) (and (memq (type-of cl-x) cl-struct-codeium-state-tags) t))

(eval-and-compile (put 'codeium-state 'cl-deftype-satisfies 'codeium-state-p))
...
Constructor for objects of type `codeium-state'." (record 'codeium-state name config proc manager-directory port port-ready-hook alive-tracker last-auth-token last-api-key last-request-id results-table pending-table))

(autoload 'codeium-config "codeium" "\


\(fn FIELD &optional STATE)" nil nil)
...
\(fn &optional STATE NOCONFIRM)" t nil)
